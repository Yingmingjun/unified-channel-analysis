...
%
%  DS Computation (NYU method from computeDSonMPC.m):
%    - Uses USC's omni PDP but NYU's DS formula
%    - Power in dB, delay in ns
%    - Standard RMS-DS: sqrt(E[τ²] - E[τ]²)
%    - No oversampling (uses native 1 GHz BW resolution)
%
%  =========================================================================
...
%  Author: Mingjun Ying
%  Date: February 2026
%  Version: 2.0 (Follows USC's exact ground truth method)
%
%  ========================================================================
...
for iLoc = 1:N_LOS
    ...
    % --- RMS Delay Spread using NYU's computeDSonMPC approach ---
    % Uses USC's omni PDP (perDelayMax) but NYU's DS formula:
    %   - Power in dB, delay in ns
    %   - Standard RMS-DS: sqrt(E[τ²] - E[τ]²)
    ...
    if d_LOS >= 5
        delay_vec_ns = (d + d_LOS - 5) / params.c * 1e9;  % Convert m to ns
    else
