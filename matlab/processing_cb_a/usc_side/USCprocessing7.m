function [PDP_omni_over,PDP_omni,PL_omni,RMS_omniv2,AS_RX,ZS_RX,AS_TX,ZS_TX,noise_thresh]=USCprocessing7(basePath,fileName,TR_distance,Ptx,thr,keyStr)
    %% Load file
    ...
    DR_max_dir = max_pk_md-noise_thresh+30; % We compute dynamic range of the capture for max_dir case
    ...
    PL_omni=Ptx+30-Pr_omni; % PL = Ptx + G_tx(15dBi) + G_rx(15dBi) - Pr_omni
