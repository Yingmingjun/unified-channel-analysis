function [PDP_omni_over,PDP_omni,PL_omni,RMS_omniv2,AS_RX,ZS_RX,AS_TX,ZS_TX,noise_thresh]=USCprocessing_NYUth_Sp(basePath,fileName,TR_distance,Ptx,thr,keyStr)
    %% Load file
