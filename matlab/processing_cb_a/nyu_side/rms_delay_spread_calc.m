function [ds_lin,md] = rms_delay_spread_calc(pdp,t,noise_floor)
% Inputs:
...
pdp_Ind=(pdp>=noise_floor); % Apply noise floor (This point is redundant)
pdp_val=db2pow(pdp).*pdp_Ind; % Apply delay gating (This point is redundant)
% pdp_val=pdp.*pdp_Ind;
