...
function generate_pl_fig(T, band, pooledFreqGHz, xlimM, ylimDB, titleStr, ...
    ...
    h_nyu_los  = scatter(los_nyu.d_m,  los_nyu.pl_db,  140, 'o', ...
                         'MarkerEdgeColor', cLOS,  'LineWidth', 1.4);
    h_usc_los  = scatter(los_usc.d_m,  los_usc.pl_db,  140, '*', ...
                         'MarkerEdgeColor', cLOS,  'LineWidth', 1.4);
    h_nyu_nlos = scatter(nlos_nyu.d_m, nlos_nyu.pl_db, 140, 'd', ...
                         'MarkerEdgeColor', cNLOS, 'LineWidth', 1.4);
    h_usc_nlos = scatter(nlos_usc.d_m, nlos_usc.pl_db, 140, 's', ...
                         'MarkerEdgeColor', cNLOS, 'LineWidth', 1.4);
