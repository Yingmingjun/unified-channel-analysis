    ...
    for id = 1:size(datasets, 1)
        ...
        for il = 1:numel(locs)
            ...
            rows(end+1, :) = { ...
                ...
                S.ple, S.sigma_sf, S.ple_cfi_w, ...
                S.ds_mean,  S.ds_cfi_w, ...
                S.asa_mean, S.asa_cfi_w, ...
                S.asd_mean, S.asd_cfi_w }; %#ok<AGROW>
        end
    end
end
...
pl  = sub.pl_db;
[ple, sigma_sf, lo, hi, w] = ci_pl_fit(sub.d_m, pl, freq_ghz, 2000, 0); %#ok<ASGLU>
