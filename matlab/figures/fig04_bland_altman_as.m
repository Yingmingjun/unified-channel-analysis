...
% labels) and +12 %% bottom (legend is OUTSIDE the axes, so there is
% no southeast box to collide with the -1.96 SD label).
drawnow;
...
% --- Marker legend OUTSIDE the axes (southoutside, horizontal) -- no
% risk of overlapping any in-axes label.
