...
% fig07_asa_cdf  ECDFs of omni ASA (azimuth-of-arrival spread) with DKW bands.
%
%   Same plotting template as fig06 but on omni_asa_d (degrees).
%
%   Output files:
%       figures/matlab/fig07_asa_cdf.png
%       figures/matlab/fig07_asa_cdf.pdf

% Mirrors python/src/channel_analysis/figures/fig07_asa_cdf.py
% Paper Section V.C, Fig. 7
...
draw_as_cdf_grid(T, 'omni_asa_d', 'Omni ASA [deg]');
sgtitle('Omni ASA CDFs with DKW 95% bands');
save_figure(fig, P.out_dir, 'fig07_asa_cdf');
close(fig);
end
